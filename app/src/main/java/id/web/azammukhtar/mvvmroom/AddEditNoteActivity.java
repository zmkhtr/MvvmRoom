...
public class AddEditNoteActivity extends AppCompatActivity {
    public static final String EXTRA_ID =  "id.web.azammukhtar.mvvmroom.EXTRA_ID";
    public static final String EXTRA_TITLE =  "id.web.azammukhtar.mvvmroom.EXTRA_TITLE";
    public static final String EXTRA_DESC =  "id.web.azammukhtar.mvvmroom.EXTRA_DESC";
    public static final String EXTRA_PRIORITY =  "id.web.azammukhtar.mvvmroom.EXTRA_PRIORITY";
